...
\usetheme{HTWDD}
\logo{\includegraphics[height=0.8cm]{logo/logoHTWDD.pdf}} % the HTWDD logo
...
\titlegraphic{\includegraphics[height=4cm]{titlegraphic/titlegraphic-example.pdf}} % your titlegraphic as pdf or similar
